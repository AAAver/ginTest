...
public class Ubs819Pril2SignsConfirmed extends BaseTest {
	...
	void setDriver() {
		setUpDriver();
		setUpExtentReport("Генерация ОСС 819-ПП Признаки СС подтверждены.");
	}
...
//	}
	...
	@Test(dependsOnMethods = "updatingUbs", description = "Актуализация 819-ПП")
	public void actualizationUbs() {
		ubs.actualizePril("2");
	}


	@Test(dependsOnMethods = "actualizationUbs", description = "Верификация")
	public void verification() throws InterruptedException {
		ubs.verify();
		String ubs819SignsConfirmedId = ubs.getUrlTail();
		Props.setProperty("ubs819SignsConfirmedId", ubs819SignsConfirmedId);
		log.info("ubs 819 Signs Confirmed ID: " + ubs819SignsConfirmedId);
	}
