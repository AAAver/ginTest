...
public class Ubs234PPTakenIntoAccount extends BaseTest {
    ...
    void setDriver() {
        setUpDriver();
        setUpExtentReport("Генерация ОСС 234-ПП Учтен.");
    }
    ...
    public void verification() throws InterruptedException {
        ubs.verify();
        String ubs234PPTakenIntoAccount = ubs.getUrlTail();
        Props.setProperty("ubs234PPIncluded", ubs234PPTakenIntoAccount);
        log.info("Ubs 234 PP Taken into Account ID: " + ubs234PPTakenIntoAccount);
    }
