...
public class Ubs819Pril2Included {
	...
	@Test
	public void pp819Included() throws InterruptedException {
		...
		Save.saveThis(driver);
		ubs.verify();
		String ubs819IcludedId = ubs.getUbsId();
		Props.setProperty("ubs819IcludedId", ubs819IcludedId);
		driver.close();
