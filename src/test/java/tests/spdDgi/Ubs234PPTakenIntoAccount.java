...
public class Ubs234PPTakenIntoAccount {
	...
	@Test
	public void pp234TakenIntoAccount() throws InterruptedException {
		...
		Save.saveThis(driver);
		ubs.verify();
		String ubs234PPTakenIntoAccount = ubs.getUbsId();
		Props.setProperty("ubs234PPTakenIntoAccount", ubs234PPTakenIntoAccount);
		driver.close();
